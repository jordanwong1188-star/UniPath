...
export default function PricingPage() {
  return <main className="min-h-screen bg-[#132c29] text-[#f2ede2]">
    ...
    <section className="border-b border-white/12"><div className="mx-auto grid max-w-7xl lg:grid-cols-[310px_1fr]">
      <header className="border-b border-white/12 px-6 py-12 lg:border-b-0 lg:border-r lg:px-10 lg:py-16"><p className="text-[10px] font-semibold uppercase tracking-[.16em] text-[#e0a17f]">Membership / 2026–27</p><h1 className="mt-5 text-4xl leading-[1.02] sm:text-5xl">Choose the support you need.</h1><p className="mt-5 text-sm leading-7 text-white/48">Research and planning stay free. Pro and Max add secure, credit-based written feedback, interview assessment, and the UniPath admissions assistant.</p></header>
