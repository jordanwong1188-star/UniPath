...
const plans = [
  ...
  { id: "max", name: "Max", descriptor: "For heavy practice across many programs", regular: "$49", price: "34", allowance: "500 feedback credits / month", accent: false, features: ["Everything in Pro", "2.5× the monthly feedback credits", "Higher interview and written-review capacity", "Larger application and attempt history", "Priority processing during peak application weeks", "Best for students applying across several schools", "500 monthly credits for feedback actions"], excluded: [], cta: "Choose Max" },
] as const;
...
export default function PricingPage() {
  return <main className="min-h-screen bg-[#132c29] text-[#f2ede2]">
    ...
    <section className="border-b border-white/12"><div className="mx-auto grid max-w-7xl lg:grid-cols-[310px_1fr]">
      <header className="border-b border-white/12 px-6 py-12 lg:border-b-0 lg:border-r lg:px-10 lg:py-16"><p className="text-[10px] font-semibold uppercase tracking-[.16em] text-[#e0a17f]">Membership / 2026–27</p><h1 className="mt-5 text-4xl leading-[1.02] sm:text-5xl">Free testing is open.</h1><p className="mt-5 text-sm leading-7 text-white/48">Practice, local drafts and self-review are available free. AI feedback and new subscriptions are paused. Paid features and prices below describe planned offerings, not currently available services.</p></header>
