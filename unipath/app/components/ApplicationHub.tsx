    ...
    <section className="mx-auto max-w-7xl px-6 py-10 lg:px-10">
      ...
      {mode === "scholarships" ? <div className="mt-8 grid gap-8 lg:grid-cols-[260px_1fr]">
        ...
        <section className="mt-6 rounded-3xl border border-[#692f46]/10 bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="mt-5 rounded-2xl border border-[#692f46]/10 bg-[#fffaf5] p-5"><p className="font-semibold">AI review of your attempt</p><p className="mt-2 text-sm leading-6 text-gray-600">When requested, your response and evaluation context are sent to OpenAI for processing. Do not include highly sensitive personal information. Drafts saved here stay on this browser.</p><button type="button" disabled={!AI_AVAILABLE || !draft.trim() || feedbackLoading} onClick={requestFeedback} className="mt-3 rounded-lg bg-[#692f46] px-5 py-3 text-sm text-white disabled:opacity-50">{feedbackLoading ? "Generating feedback…" : AI_AVAILABLE ? "Request AI feedback" : AI_PAUSED_MESSAGE}</button></div>
