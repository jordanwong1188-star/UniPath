    ...
    <section className="relative overflow-hidden border-b border-white/8 bg-[#0d1620]">
      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-[1fr_360px] lg:px-10 lg:py-22">
        <div className="relative max-w-4xl">
          ...
          <div className="mt-8 flex flex-wrap gap-2"><span className="rounded-full border border-white/10 bg-white/[.04] px-3 py-1.5 text-xs text-white/55">{transferCount} transfer-friendly listings</span><span className="rounded-full border border-white/10 bg-white/[.04] px-3 py-1.5 text-xs text-white/55">{currentStudentCount} current-student listings</span></div>
        </div>
